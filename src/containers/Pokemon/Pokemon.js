...
const Pokemon = () => {
        ...
        <React.Fragment>
            <Grid stackable container padded columns={2}>
                <Grid.Row style={{ alignItems: 'center' }}>
                    <Grid.Column width={6}>
                        <ImageSwitcher images={pokemon.images} charName={pokemon.name} large />
                    </Grid.Column>
                    <Grid.Column width={10}>
                        <h2 className='pokemon-name'>{ pokemon.name }({ pokemon.jpName })</h2>
                    ...
                    <Grid.Row>
                        <Grid.Column>
                            <Statistic className="static"color='red'>
                                ...
                                <Statistic.Label>Height<span className="unit">(ft.)</span></Statistic.Label>
                            </Statistic>
                        </Grid.Column>
                        <Grid.Column>
                            <Statistic className="static" color='orange'>
                                <Statistic.Value>{pokemon.weight}</Statistic.Value>
                                <Statistic.Label>Weight<span className="unit">(lbs)</span></Statistic.Label>
                            </Statistic>
                        </Grid.Column>
                        <Grid.Column>
                            <Statistic className="static" color='yellow'>
                                <Statistic.Value>{pokemon.catchRate}</Statistic.Value>
                                <Statistic.Label>Catch Rate<span className="unit">(%)</span></Statistic.Label>
                            </Statistic>
                        </Grid.Column>
                        <Grid.Column>
                            <Statistic className="static" color='olive'>
                                <Statistic.Value>{pokemon.genderRatioMale}/{pokemon.genderRatioFemale}</Statistic.Value>
                                <Statistic.Label>Gender Ratio<span className="unit">(Male/Female)</span></Statistic.Label>
                            </Statistic>
                        </Grid.Column>
                        <Grid.Column width={4}>
                        ...
                        <Grid.Column width={8}>
                            <Statistic className="static" color='blue'>
                                <Statistic.Value className="long-text">{pokemon.eggGroups}</Statistic.Value>
                                <Statistic.Label>Egg Groups</Statistic.Label>
                            </Statistic>
                        </Grid.Column>
                        <Grid.Column width={8}>
                            <Statistic className="static" color='violet'>
                                <Statistic.Value className="long-text">{pokemon.evs}</Statistic.Value>
                                <Statistic.Label>EVs</Statistic.Label>
                            </Statistic>
                        </Grid.Column>
                        <Grid.Column width={8}>
                            <Statistic className="static" color='purple'>
                                <Statistic.Value className="long-text">{pokemon.abilities}</Statistic.Value>
    ...
    return (
            <Container>
                <PokemonInfo>
                    { loading ? <LoaderSkeleton /> : pokeInfo }
                </PokemonInfo>
            </Container>
    )
}
